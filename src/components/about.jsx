...
{/* About ECE */}
    <div className='flex flex-row gap-8 justify-between ml-4 mr-4 items-center'>

    <img class="filter brightness-100 h-auto max-w-lg rounded-lg" src={SSN} alt="image description"/>
...
{/* About SSN */}
    <div className='mt-16 flex flex-row gap-8 justify-between ml-4 mr-4 items-center'>
    <div className='flex flex-col gap-4 '>
        <h1 className='font-bold text-4xl text-center'>SSNCE</h1>
        <p className='text-right'>Sri Sivasubramaniya Nadar (SSN) College of Engineering, founded by Shiv Nadar, Founder, HCL Technologies, stands out as a premier center of higher learning with a mission of pursuing excellence in education and research. The institution, with its diverse and dynamic community of students, faculty and staff, offers a distinctive combination of some of graduate, undergraduate and research programs, and is spread over a sprawling 250 acres of sylvan surroundings.
...
The institute is home to aesthetically designed buildings with state of the-art computer and internet facilities, seminar halls, auditoriums and well stocked libraries, sports and games fields in addition to an indoor stadium with gymnasium.</p>
    ...
    <img class="h-full max-w-lg rounded-lg" src={SSNCE} alt="image description"/>
    </div>

{/* About Chennai */}
<div className='mt-16 flex flex-row gap-8 justify-between ml-4 mr-4 items-center'>
    <img class="h-full max-w-lg rounded-lg" src={Chennai} alt="image description"/>
    <div className='flex flex-col gap-4 '>
